  ...
  try {
    ...
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        { 
          role: "system", 
          content: "You are a balanced and neutral psychologist specializing in emotional assessment. Focus specifically on the user's CURRENT emotional state and TODAY's feelings. Provide concise questions without quotation marks that help identify how they're feeling right now." 
        },
        { 
          role: "user", 
          content: resp === 'start' 
