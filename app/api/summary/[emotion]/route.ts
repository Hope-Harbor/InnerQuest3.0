...
export async function GET(
  ...
  try {
    ...
    const prompt = isChinese
      ...
      : `Provide a clear and supportive message with useful and practical suggestions that are applicable for ${engRole} feeling ${emotion} within 50 words. Use second person perspective and a casual and optimistic tone. It should be conversational, providing emotional value assistance.`;
    ...
    return NextResponse.json({
      ...
      summary: userLang === 'zh-TW'
        ? "請嘗試認識自己的情緒，並考慮適當的自我照顧方式。當你感到壓力大時，試著承認自己的情緒，並考慮一些自我照顧的方法——例如，你可以對自己說：「我現在真的很焦慮，但沒關係」，然後休息一下、去散步，或找一個信任的人聊聊。"
        : "Try to acknowledge your feelings and consider self-care strategies—for example, if you're feeling overwhelmed, say to yourself, 'I’m really stressed right now, and that’s okay,' then take a break, go for a walk, or talk to someone you trust."
    });
  }
}